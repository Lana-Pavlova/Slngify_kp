...
//    var lessonIdForUpdate by remember { mutableStateOf<String?>(lessonIdForSection) } // Добавляем переменную с дефолтным значением
//
//
...
//                    showResult = false
//                },
//                lessonId = lessonIdForUpdate // используем lessonIdForUpdate
//            )
//        }
//        else{
//            QuestionScreen(
