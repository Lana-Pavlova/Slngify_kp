            ...
            TopAppBar(
                ...
                navigationIcon = {
                    IconButton(onClick = { navController.navigateUp() }) {
                        Icon(
                            painter = androidx.compose.ui.res.painterResource(id = com.example.slngify_kp.R.drawable.back),
...
fun ResultScreen(
    ...
    Column(
        ...
        Text("Правильных ответов: $numberOfCorrectAnswers из $numberOfQuestions")
        Spacer(modifier = Modifier.height(16.dp))
        CircularProgressIndicator(
            progress = progress,
        ...
        if (incorrectQuestions.isNotEmpty()){
            Text(text = "Ошибки в вопросах:", style = MaterialTheme.typography.titleMedium)
            ...
            Box(
                ...
                AsyncImage(
                    model = ImageRequest.Builder(LocalContext.current)
                        ...
                        .crossfade(true)
                        .size(Size.ORIGINAL) // Important!  Use original size for initial loading
                        .build(),
...
private fun updateUserProgress(
    ...
    db.runTransaction { transaction ->
        ...
        val updatedCorrectAnswers = userProgress.correctAnswers.toMutableMap().apply {
